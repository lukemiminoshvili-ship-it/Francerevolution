...
const TimelineCard: React.FC<TimelineCardProps> = ({ event, onClick, side }) => {
  ...
  return (
    ...
    >
      {/* Central Connector Dot - Enhanced animation */}
      ...
      <div className={`flex flex-col md:flex-row items-center w-full ${isLeft ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
        ...
        {/* The Card - Larger and more refined */}
        <div className={`w-full md:w-[48%] group cursor-pointer`} onClick={() => onClick(event.id)}>
          <div className="bg-[#1e1a16] p-2 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.7)] border border-stone-800 relative overflow-hidden transition-all duration-500 hover:border-[#c5a059]/50 hover:-translate-y-3">
            ...
            <div className="absolute top-4 left-4 w-6 h-6 border-t-2 border-l-2 border-stone-800 pointer-events-none group-hover:border-[#c5a059]/40 transition-colors"></div>
            <div className="absolute top-4 right-4 w-6 h-6 border-t-2 border-r-2 border-stone-800 pointer-events-none group-hover:border-[#c5a059]/40 transition-colors"></div>
            <div className="absolute bottom-4 left-4 w-6 h-6 border-b-2 border-l-2 border-stone-800 pointer-events-none group-hover:border-[#c5a059]/40 transition-colors"></div>
            <div className="absolute bottom-4 right-4 w-6 h-6 border-b-2 border-r-2 border-stone-800 pointer-events-none group-hover:border-[#c5a059]/40 transition-colors"></div>
          </div>
        </div>
